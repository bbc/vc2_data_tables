...
<https://www.bbc.co.uk/rd/projects/vc-2>`_. These values may be used either via
the :py:mod:`vc2_data_tables` Python module or, in most cases, values may be
read from CSV formatted data files located in ``vc2_data_tables/csv/*.csv``.
